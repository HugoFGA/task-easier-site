// Arquivo: app-mobile.js | Versão: 6 (Task Easier — página mobile/web, fora da extensão)
// ═══════════════════════════════════════════════════════════
...
// rola normalmente; só o formulário no topo e a busca no rodapé ficam fixos.
function loadTasksView() {
  ...
  Promise.all([gsCall('getTasks', [false]), gsCall('getEvents', [false])])
    .then(function(results) {
      ...
      lastLoadedItems = all;
      renderTasksList(filterItems(all));
    })
    .catch(function(e) {
