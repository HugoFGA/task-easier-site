// Arquivo: app-mobile.js | Versão: 2 (Task Easier — página mobile/web, fora da extensão)
// ═══════════════════════════════════════════════════════════
...
// Lista TODAS as tarefas e todos os eventos (não só os de hoje), ordenados
// por data/hora (os sem data ficam no fim) — pensada para ficar sempre
// visível, rolando de forma independente do formulário fixo no topo.
